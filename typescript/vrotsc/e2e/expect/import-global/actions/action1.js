...
(function () {
  ...
  const tests_1 = VROES.importLazy('com.vmware.pscoe.tests')
  const sub_1 = VROES.importLazy('com.vmware.pscoe.tests/sub')
  const action1_1 = VROES.importLazy('com.vmware.pscoe.tests/action1')
  const action2_1 = VROES.importLazy('com.vmware.pscoe.tests/action2')
  const action1_2 = VROES.importLazy('com.vmware.pscoe.tests/action1')
  const subaction1_1 = VROES.importLazy('com.vmware.pscoe.tests/sub/subaction1')
  const subaction2_1 = VROES.importLazy('com.vmware.pscoe.tests/sub/subaction2')
  const subaction1_2 = VROES.importLazy('com.vmware.pscoe.tests/sub/subaction1')
  // new TestClass1();
