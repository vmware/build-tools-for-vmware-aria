...
if (licenseTechnicalPreview == "true" || licenseTechnicalPreview == "yes" || licenseTechnicalPreview == "y") {
    ...
    File header = projectPath.resolve("actions/license_data/_license/template_header.txt.ftl").toFile()
    File license = projectPath.resolve("actions/license_data/_license/template_license.txt.ftl").toFile()
