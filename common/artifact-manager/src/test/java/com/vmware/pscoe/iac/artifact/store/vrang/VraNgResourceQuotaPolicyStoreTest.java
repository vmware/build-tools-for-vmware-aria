...
//	}
	...
	void testExportContentWithAllResourceQuotaPolicies() {
		...
		VraNgResourceQuotaPolicy rqPolicy = new VraNgResourceQuotaPolicy("df60ff9e-4027-48d1-a2b5-5229b3cee282", "RQ01",
			"com.vmware.policy.resource.quota", "b899c648-bf84-4d35-a61c-db212ecb4c1e", "b2c558c8-f20c-4da6-9bc3-d7561f64df16", "HARD", "TEST", new VraNgResourceQuotaDefinition());
	...
	void testExportContentWithSpecificResourceQuotaPolicies() {
		...
		VraNgResourceQuotaPolicy rqPolicy = new VraNgResourceQuotaPolicy("df60ff9e-4027-48d1-a2b5-5229b3cee282", "RQ01",
			"com.vmware.policy.resource.quota", "b899c648-bf84-4d35-a61c-db212ecb4c1e", "VIDM-L-01A", "HARD", "TEST", new VraNgResourceQuotaDefinition());
