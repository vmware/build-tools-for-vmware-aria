...
public class DeploymentLimitPolicyFsMocks extends VraNgFsMock {
	/**
	...
	public DeploymentLimitPolicyFsMocks(File tempDir) {
		super(tempDir);
	}
	...
	public File getWorkdir() {
		return Paths.get(this.tempDir.getPath(), DIR_POLICIES, DEPLOYMENT_LIMIT_POLICY).toFile();
	}
	 ...
	 */
	public void addPolicy(VraNgDeploymentLimitPolicy policy) {
		File file = Paths.get(
