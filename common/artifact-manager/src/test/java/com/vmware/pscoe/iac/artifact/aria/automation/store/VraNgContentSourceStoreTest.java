...
public class VraNgContentSourceStoreTest {
	...
	// TODO not easy to implement the test because the VraNgContentSourceBase is too
	// complext to be mocked. VraNgContentSourceBase is casted dynamically to other
	// classes
	// @Test
	...
	// when( vraNgPackageDescriptor.getContentSource()).thenReturn(null);
	// when( restClient.getContentSourcesForProject("mockedProjectId")).thenReturn(
	// contentSources );
	...
	// fsMocks.getTempFolderProjectPath(), expectedContentSources );
	// }
