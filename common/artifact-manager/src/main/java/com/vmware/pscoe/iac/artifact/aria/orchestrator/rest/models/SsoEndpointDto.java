 ...
 * #L%
 */
package com.vmware.pscoe.iac.artifact.aria.orchestrator.rest.models;
...
public class SsoEndpointDto {
	...
	public String toString() {
		return "SsoEndpointDto{" + "lastUpdated = '" + lastUpdated + '\'' + ",endPointType = '" + endPointType + '\''
				+ ",serviceInfoId = '" + serviceInfoId
				+ '\'' + ",createdDate = '" + createdDate + '\'' + ",endPointAttributes = '" + endPointAttributes + '\''
				+ ",id = '" + id + '\''
