 ...
 * #L%
 */
package com.vmware.pscoe.iac.artifact.aria.logs.rest.v1.models;
...
@JsonPropertyOrder({ "id", "enabled", "emailEnabled", "vcopsEnabled", "alertType", "name", "hitCount", "hitOperator",
		"searchPeriod", "searchInterval",
		"emails", "info", "recommendation", "vcopsResourceName", "vcopsResourceKindKey", "vcopsCriticality",
		"lastRanAt", "lastRanAtString", "nextRunAt",
		"nextRunAtString", "runCount", "lastRunTime", "totalRunTime", "lastHitTimestamp", "lastHitTimestampString",
		"ownerUuid", "ownerName", "webhookEnabled",
