...
public class RestClientVcfAutoPrimitive extends RestClient {
	...
	protected void triggerVroDataCollectionPrimitive() {
		...
		String localVroIntegration = configuration.getVroIntegration();
		LOGGER.info("Used vCF Autom Integration Configurations: {}", localVroIntegration);
		// check if vro Integration name is defined
		String vroIntegrationId = null;
		if (localVroIntegration == null || localVroIntegration.isEmpty()) {
			...
			for (JsonElement element : contentArray) {
				if (element.getAsJsonObject().get("name").getAsString().equals(localVroIntegration)) {
