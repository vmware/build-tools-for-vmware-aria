...
public class RestClientVroBasicAuthNInterceptor extends RestClientRequestInterceptor<ConfigurationVro> {
	...
	public RestClientVroBasicAuthNInterceptor(ConfigurationVro configuration, RestTemplate restTemplate) {
	...
	public ClientHttpResponse intercept(HttpRequest request, byte[] body, ClientHttpRequestExecution execution)
		...
		try {
			...
			// Basic authentication could work with user without domain thus handling this
			// case here.
