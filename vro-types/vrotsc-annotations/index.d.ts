...
// 	<workflow-item name="item3" out-name="item4" type="condition" alt-out-name="item2"
// 		comparator="0">
// 		<display-name><![CDATA[Decision]]></display-name>
// 		<script encoded="false"><![CDATA[// Generated by the system, cannot be edited
// return (waitingTimer !== null);]]></script>
// 		<in-binding>
// 			<bind name="waitingTimer" type="Date" export-name="waitingTimer" />
// 		</in-binding>
// 		<out-binding />
// 		<condition name="waitingTimer" type="Date" comparator="4" label="null" />
